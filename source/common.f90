! Collection of global values available everywhere
! in the code.
module Common
...
!
  real, parameter :: c_light_cgs = 2.99792458d10 ! speed of light
!
! Rydberg Constant for Hydrogen - cgs
...
!  
! Logicals for first pillar (iwave,ix,iy) = (0,0,0) and root (0,0) processor column
  logical :: lfirst,lroot
!
  real, parameter :: G_Newton_cgs=6.6742d-8 ! Gravitational constant
